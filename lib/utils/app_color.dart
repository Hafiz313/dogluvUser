...
final Color kYellowImageBorder = HexColor("#fbb929");
final Color kLightBlue = HexColor("#8ebfdf");
final Color kDialogColorBG = HexColor("#f5f4f4");
final Color kPinkColor = HexColor("#9b59b6");
...
final Color kProfileGray = HexColor("#454849");
...
final Color kCheckBoxBgColor = HexColor("#252525");
final Color kMatchScreenBlueColor = HexColor("#34495e");
final Color kGreenLeaderColor = HexColor("#2ecc71");
final Color kBgBlueSlider4 = HexColor("#3498db");
...
final Color kDividerGrayColor = HexColor("#646464");
final Color kBlueTextPostColor = HexColor("#b4dffb");
final Color kBlueTextPostBtnColor = HexColor("#1d5e8a");
