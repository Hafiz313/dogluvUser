...
const String kNameOfChild= "Name of Child";
const String kYes= "Yes";
const String kNo= "No";
const String kName= "Name";
const String kCurrentPackLeader= "Current Pack Leader ";
const String kBoostUser= "Boost User";
const String kManageProfile= "Manage Profile";
const String kRecentChats= "Recent Chats";
const String kSTRONG= "STRONG";
const String kYOUR_RANK= "YOUR RANK";
const String kMATCHES= "MATCHES";
const String kBE_THE_NEXT_PACK_LEADER= "BE THE NEXT PACK LEADER";
const String kMassageCenter= "Massage Center";
const String kAnnounces= "Announces";
const String kWEAK= "WEAK";
const String kTakePhoto= "Take Photo";
const String kCONVERSATIONS= "CONVERSATIONS";
const String kChooseFromLibrary = "Choose from Library";
const String kPosts= "Posts";
const String kBuyPackage= "Buy Package";
const String kMAKE_ME_PACK_LEADER= "MAKE ME PACK LEADER";
const String kTakePart= "Take part in the pack leader's championship. Each month a pack leader is appointed. ";
const String kBecomingPack= "Becoming pack leader couldn’t be easier, you must have been the longest-standing dog on the throne for 30 days. ";
const String kToDoSo= "To do so, leader pack boosters are available. By using the booster, your count gets bigger. It stops when another user uses the pack leader booster. A little piece of advice : get strategic to prevail! As this will result in having your photo crowned in gold for a month.";
...
const String kTellUsMoreAboutYourServices = "Tell us more about your services";
const String kEnterAddress = "Enter Address";
const String kEnterPrice= "Enter Price";
const String kRESET= "RESET";
const String kQuestionnaire = "Questionnaire ";
const String kChangePassword= "Change Password";
const String kChangePasswordText= "Instructions to reset your password would be sent to your registered email address.";
const String kLoremIpsum= "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore";
const String kAddDiscountCode= "Add Discount Code";
const String kEnterStoreName= "Enter Store Name";
const String kEnterFirstName= "Enter First Name";
const String kLocation= "Location";
const String kEDIT= "EDIT";
const String kSAVE= "SAVE";
const String kDELETE_ACCOUNT= "DELETE ACCOUNT ";
...
const String kFinances= "Finances";
const String kLanguageChoice= "Language Choice";
const String kLanguage= "Language";
const String kLegalInformation= "Legal informations";
const String kDiffusionRules= "Diffusion rules";
const String kCGU= "CGU";
const String kCGV= "CGV";
const String kHelp= "Help";
const String kWarnings= "Warnings";
const String kRightsAndObligations= "Rights and obligations";
...
const String kADD_CHILD= "ADD CHILD";
const String kListAnyAdditional= "List any additional people in household";
const String kWhoResponsible= "Who will be responsible  for the dog’s care?";
const String khouseholdExperiencedAllergies = "Has anyone in your household experienced allergies or asthma?";
const String kFor10_15_years= "Are you prepared to care for this dog for 10-15 years?";
const String kEventUnderCare= "Who will provide for your pet in the event that you become ill or unable to care for him/her?";
const String kLookingToAdopt = "Why are you looking to adopt a dog?";
const String kCompanionSpouse= "Companion for you/spouse";
const String kCompanionChildren= "Companion for children";
const String kCompanionPet= "Companion for pet";
const String kReplaceDeceased= "Replace lost/deceased dog";
const String kGiftFor= "Gift for...";
const String kOtherPleaseExplain= "Others ( please explain )";
const String kOwnYourHome= "Do you rent or own your home?";
const String kAnyFollowing= "Do you have any of the following?";
const String kHaveFence= "Do you have a fence?";
const String kDogSleepNight= "Where will your dog sleep at night?";
const String kLeftAlone= "Where will (s)he left alone?";
const String kHoursLeftAlone= "How many hours a day will your dog be left alone?";
const String kDogExercised= "How often will your dog be exercised?";
const String kFirstPet= "Will this dog be your first pet?";
const String kOtherPets= "Do you have any other pets?";
const String kSEND_REQUEST= "SEND REQUEST";
const String kIAgreeWith= "I agree with";
const String kFirstName= "First Name";
const String kTermsAndConditions= "Terms and Conditions";
const String kDogDoor= "Dog door";
const String kPatio= "Patio";
const String kBalcony= "Balcony";
const String kGarden= "Garden";
const String kSwimmingPool= "Swimming Pool";
const String kOwn= "Own";
const String kRent= "Rent";
const String kReply= "Reply";
const String kSex= "Sex";
const String kChildren_with_age= "Children (With Ages)";
const String kDistance= "Distance";
const String kShowOnlyProSellers= "Show only Pro Sellers";
const String kAvailableForAdoption= "Show only dogs available \n for adoption";
const String kStoreName= "Store Name";
const String kDiscountCode= "Discount Code";
...
const String kSelectPhoto= "Select Photo";
...
const String kKeepSwiping= "Keep Swiping";
const String kSendMessage= "Send Message";
const String kMemberSince = "Member Since";
const String kLastActivity = "Last Activity";
...
const String kSendRequest= "Send Request";

const String kBasicPost= "Basic Post";
const String kPHYSICAL_ADDRESS= "PHYSICAL ADDRESS";
const String kSellServices= "Sell Services";
const String kPackLeaderOfMonth= "Pack Leader of Month";
