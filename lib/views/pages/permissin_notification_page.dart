...
class PermissionNotificationPage extends StatelessWidget {
  static const id="permission_notification_page";
  @override
    ...
    return BaseScaffold(
      ...
      body: Padding(
        padding:  EdgeInsets.symmetric(
          horizontal: AppSizes.appHorizontalLg * .4
        ),
        child: Column(
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(children: [
                  Text(kNotificationText1,style: simpleText(color: kTextBlueColor,fontSize: 16),),
                  SizedBox(height: AppSizes.appVerticalLg * 0.3,),
                  Text(kNotificationText2,style: simpleText(color: kTextBlueColor,fontSize: 16),),
